...
function sassyscores_setup() {
	 ...
	 * to change 'sassyscores' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'sassyscores', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'sassyscores' ),
	) );
...
function sassyscores_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'sassyscores_content_width', 1170 );
}
...
function sassyscores_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Blog Sidebar', 'sassyscores' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'sassyscores' ),
		...
		register_sidebar( array(
		'name'          => esc_html__( 'Footer Sidebar 1', 'sassyscores' ),
		'id'            => 'footer-1',
		'description'   => esc_html__( 'Add widgets here.', 'sassyscores' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		...
		register_sidebar( array(
		'name'          => esc_html__( 'Footer Sidebar 2', 'sassyscores' ),
		'id'            => 'footer-2',
		'description'   => esc_html__( 'Add widgets here.', 'sassyscores' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		...
		register_sidebar( array(
		'name'          => esc_html__( 'Footer Sidebar 3', 'sassyscores' ),
		'id'            => 'footer-3',
		'description'   => esc_html__( 'Add widgets here.', 'sassyscores' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
